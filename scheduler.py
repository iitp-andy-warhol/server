...
def get_optimized_order_set(pdf, rs, inventory):
    if len(pdf) == 0:
        return None
    pdf['partialid'] = 0
    pdf['profit'] = 1
    ...
    in_inventory, not_in_inventory = partialize_by_rgb(all_partials, inventory)
    ...
    next_orderset = od.makeOrderSet(direction=rs['direction'],
